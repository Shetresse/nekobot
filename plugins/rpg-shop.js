...
['🐈 𝘾𝙤𝙢𝙥𝙧𝙖𝙧 𝙘𝙤𝙣 𝘾𝙤𝙞𝙣𝙨', '/buy2']
  ...
  await conn.sendHydrated(m.chat, `*No tiene sufuciente 𝙓𝙋 para comprar ${count} Diamantes* 💎\n\n*Le recomiendo que interactúe con NekoBot para Obtener experiencia, puede ver su experiencia con el comando ${usedPrefix}exp o ${usedPrefix}experiencia. También puede comprar con Coins con el Comando ${usedPrefix}buy2*`, wm, null, null, null, [
['🐈 𝘾𝙤𝙢𝙥𝙧𝙖𝙧 𝙘𝙤𝙣 𝘾𝙤𝙞𝙣𝙨', '/buy2'],
], m,)
}
